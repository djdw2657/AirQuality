...
// 앱아이디 : ca-app-pub-3109184144061937~1739001196
// 앱아이디 : ca-app-pub-3109184144061937~1739001196
// 광고단위아이디 : ca-app-pub-3109184144061937/7617449181

// 전면광고단위아이디 : ca-app-pub-3109184144061937/4308759565
// 43b36b8e-ab72-49e7-b8eb-77519ae7128c
class MainActivity : AppCompatActivity() {
    ...
    private fun getAirQualityData(latitude: Double, longitude: Double) { // 레트로핏 객체를 이용하면 AirQualityService 인터페이스 구현체를 가져올 수 있습니다.
        ...
        retrofitAPI.getAirQualityData(
            latitude.toString(), longitude.toString(), "43b36b8e-ab72-49e7-b8eb-77519ae7128c"
